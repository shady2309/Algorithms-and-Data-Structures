...
int findElement(int value)
{
    ...
    while (hash_table[Gethash(value)] != value && hash_table[Gethash(value)] !=-1) {
        index = (index + i * i) % (sizeof(hash_table));
        i++;
    }
...
int main()
{
    ...
    addNewElement(polynomialHashing("maly ksiaze"));
    addNewElement(polynomialHashing("hobbit"));
    
    findElement(polynomialHashing("hobbit"));
